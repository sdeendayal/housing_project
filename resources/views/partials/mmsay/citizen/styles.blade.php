<style>
    ...
    *, body {
    ...
    .citizen-download-loader.is-active {
        opacity: 1;
        visibility: visible;
        pointer-events: auto;
    }

    .citizen-download-loader.hidden {
        display: flex;
    }

    .citizen-download-loader__card {
        background: #fff;
        border-radius: 16px;
        padding: 24px 28px;
    ...
    .citizen-download-loader__spinner {
        width: 40px;
        height: 40px;
        margin: 0 auto 12px;
        ...
        border-radius: 50%;
        animation: citizenDownloadSpin 0.75s linear infinite;
    }

    @keyframes citizenDownloadSpin {
        to { transform: rotate(360deg); }
    }

    .citizen-download-loader__text {
        font-size: 12px;
        font-weight: 700;
        color: #334155;
        margin: 0;
