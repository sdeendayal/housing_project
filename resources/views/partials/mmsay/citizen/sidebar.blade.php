...
<nav id="sidebar"
    ...
    <button id="sidebarCollapseToggle" type="button" class="transition-all shrink-0" title="Toggle Sidebar">
        <span class="material-symbols-outlined text-[16px] transition-transform duration-300">chevron_left</span>
    </button>
    ...
    <div class="flex-1 overflow-y-auto px-2 py-3">
        <p class="menu-heading text-[8px] font-bold uppercase tracking-widest text-slate-400 px-2 mb-1.5">Menu</p>
        ...
        <a class="nav-v2 {{ $activeNav === 'property-details' ? 'active' : '' }}" href="{{ route('citizen.property-details') }}">
            ...
            <span class="nav-text">Allotted Property Details</span>
        </a>
        ...
        <a class="nav-v2 {{ $activeNav === 'allotment-letter' ? 'active' : '' }}" href="{{ route('citizen.allotment-letter') }}">
            ...
            <span class="nav-text">Allotment Letter</span>
        </a>
        ...
        {{-- 6. Possession Application Request Form --}}
        <a class="nav-v2 d-none hidden {{ $activeNav === 'possession-certificate' ? 'active' : '' }}" style="display: none !important;" href="{{ route('citizen.possession-certificate') }}">
            ...
            <span class="nav-text">Possession Application Request Form</span>
        </a>
        ...
        <a class="nav-v2 {{ $activeNav === 'grievances' ? 'active' : '' }}" href="{{ route('citizen.grievances.index') }}">
            ...
            <span class="nav-text">Grievances</span>
        </a>
        ...
        <div class="pp-nav-group mb-1 mt-1">
            <button type="button"
                ...
                <span class="flex items-center gap-1 min-w-0 flex-1 text-left nav-text">
                    <span class="truncate">Physical Possession</span>
                    <span class="pp-scheme-new-badge-sm shrink-0">🔥 NEW</span>
                </span>
                <span id="ppNavChevron" class="material-symbols-outlined text-[18px] text-slate-400 transition-transform duration-200 shrink-0 nav-text {{ $ppSubmenuOpen ? 'rotate-180' : '' }}">expand_more</span>
            </button>
            ...
            <div id="ppNavSubmenu" class="pp-nav-submenu {{ $ppSubmenuOpen ? '' : 'hidden' }}">
                ...
                <a class="nav-v2 {{ request()->routeIs('pp.citizen.submit') ? 'active' : '' }} pl-7" href="{{ route('pp.citizen.submit') }}">
                    ...
                    <span class="nav-text">Complete Possession</span>
                </a>
                @endif
    ...
    <div class="p-2.5 border-t border-slate-100">
        <div class="sidebar-user-v2 p-2 flex items-center gap-2">
            ...
            <a href="{{ route('citizen.logout') }}" class="text-slate-400 hover:text-red-500 sidebar-user-logout" title="Logout">
