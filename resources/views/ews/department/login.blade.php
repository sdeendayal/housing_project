...
<body class="bg-[#0f172a] text-slate-100 min-h-screen flex overflow-x-hidden">
    ...
    <div class="w-full min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-[55%] relative flex-col justify-between p-16 overflow-hidden">
            ...
            <div class="absolute inset-0 bg-cover bg-center transition-transform duration-[10000ms] hover:scale-105" style="background-image: url('{{ asset('images/ews_bg.png') }}');"></div>
        ...
        <div class="w-full lg:w-[45%] flex items-center justify-center p-8 bg-[#1e293b] relative">
            ...
            <div class="w-full max-w-sm relative z-10">
                ...
                <div class="text-center mb-8">
                    <img src="{{ asset('Haryana_emblem.png') }}" class="w-14 h-14 mx-auto mb-4 object-contain" alt="Haryana Govt Emblem">
