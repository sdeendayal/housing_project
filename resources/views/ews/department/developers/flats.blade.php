    ...
    <script>
        ...
        function exportData(format) {
            ...
            Swal.fire({
                ...
                html: '<div class="text-xs text-slate-500 font-medium">Please wait while builder flat records are prepared for download.</div>',
            ...
            fetch(url.toString())
                ...
                .then(blob => {
                    ...
                    a.href = downloadUrl;
                    a.download = 'ews_builder_flats_' + (format === 'excel' ? 'excel.csv' : 'csv');
                    ...
                    Swal.fire({
                        ...
                        text: 'Builder flat list saved successfully.',
                        timer: 2500,
