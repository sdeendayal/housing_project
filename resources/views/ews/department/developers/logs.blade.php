    ...
    <script>
        ...
        function exportData(format) {
            ...
            Swal.fire({
                ...
                html: '<div class="text-xs text-slate-500 font-medium">Please wait while activity logs are prepared for download.</div>',
            ...
            fetch(url.toString())
                ...
                .then(blob => {
                    ...
                    a.href = downloadUrl;
                    a.download = 'ews_developer_logs_' + (format === 'excel' ? 'excel.csv' : 'csv');
                    ...
                    Swal.fire({
                        ...
                        text: 'Developer activity logs saved successfully.',
                        timer: 2500,
