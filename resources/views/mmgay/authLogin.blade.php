                    ...
                    <div
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <div class="space-y-1.5">
                                    @foreach ([['ews/citizen/login', 'person', 'Citizen Login'], ['ews/developer/login', 'developer_mode', 'DTP Login'], ['ews/department/login', 'apartment', 'Department Login']] as [$portalUrl, $portalIcon, $portalLabel])
