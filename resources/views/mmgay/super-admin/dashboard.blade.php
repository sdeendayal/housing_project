...
@section('content')
    ...
    <main class="min-h-screen bg-slate-100 p-6 pt-20 ml-[260px] w-[calc(100%-260px)] overflow-x-hidden">
        ...
        <div class="w-full bg-[#111827] rounded-2xl p-4 sm:p-5 shadow-xl mb-6">
          ...
          transition-all duration-300 hover:shadow-blue-500/20 hover:-translate-y-1">
                ...
                <a href="{{ route('superadmin.all-villages') }}"
                    class="block bg-[#1F2937] rounded-xl p-4 text-center border border-gray-700 shadow
            transition-all duration-300 hover:shadow-green-500/20 hover:-translate-y-1">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-bold text-green-400">
                        {{ $summary->TotalVillages }}
                    </h2>
                </a>

                <!-- Beneficiaries -->
                <!-- Beneficiaries (Clickable Card Link) -->
                <a href="{{ route('superadmin.beneficiaries.index') }}"
                    class="block bg-[#1F2937] rounded-xl p-4 text-center border border-gray-700 shadow
            transition-all duration-300 hover:shadow-indigo-500/20 hover:-translate-y-1">
    ...
    transition-all duration-300 hover:shadow-orange-500/20 hover:-translate-y-1">
          ...
          transition-all duration-300 hover:shadow-emerald-500/20 hover:-translate-y-1 cursor-pointer">
                ...
                <div
                    class="bg-[#1F2937] rounded-xl p-4 text-center border border-gray-700 shadow
                            transition-all duration-300 hover:shadow-red-500/20 hover:-translate-y-1">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-bold text-red-400">
        ...
        <div class="w-full bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden mb-8">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-5">
                    ...
                    <!-- Allotment -->
                    <div
                        class="group bg-gradient-to-br from-blue-50 to-white border border-blue-100 rounded-2xl p-5 text-center hover:-translate-y-1 hover:shadow-lg transition">
                        ...
                        <h2 class="mt-2 text-3xl font-bold text-blue-600">
                            {{ number_format($summary->TotalAllotment) }}
                        </h2>
                    ...
                    <!-- Paid -->
                    <div
                        class="group bg-gradient-to-br from-emerald-50 to-white border border-emerald-100 rounded-2xl p-5 text-center hover:-translate-y-1 hover:shadow-lg transition">
                        ...
                        <h2 class="mt-2 text-3xl font-bold text-emerald-600">
                            {{ number_format($summary->TotalPaid) }}
                        </h2>
                    ...
                    <!-- Pending (FIXED LOGIC) -->
                    <div
                        class="group bg-gradient-to-br from-red-50 to-white border border-red-100 rounded-2xl p-5 text-center hover:-translate-y-1 hover:shadow-lg transition">
                        ...
                        <h2 class="mt-2 text-3xl font-bold text-red-600">
                            {{ number_format($summary->TotalAllotment - $summary->TotalPaid) }}
                        </h2>
                    ...
                    <!-- Registration -->
                    <div
                        class="group bg-gradient-to-br from-violet-50 to-white border border-violet-100 rounded-2xl p-5 text-center hover:-translate-y-1 hover:shadow-lg transition">

                        <div class="w-14 h-14 mx-auto mb-4 rounded-full bg-violet-100 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-violet-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <!-- Matched -->
                    <div
                        class="group bg-gradient-to-br from-cyan-50 to-white border border-cyan-100 rounded-2xl p-5 text-center hover:-translate-y-1 hover:shadow-lg transition">
                    ...
                    <!-- Unmatched -->
                    <div
                        class="group bg-gradient-to-br from-amber-50 to-white border border-amber-100 rounded-2xl p-5 text-center hover:-translate-y-1 hover:shadow-lg transition">
        ...
        {{-- <div class="bg-white rounded-2xl shadow overflow-hidden mt-6">
            ...
            <div class="p-4 border-b font-semibold">
                District Wise Summary (All Phases Combined)
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <thead class="bg-gray-100 text-gray-600">
                        <tr>
                            ...
                            <th class="p-3">Villages</th>
                            <th class="p-3">Beneficiaries</th>
                            <th class="p-3 text-green-600">Paid</th>
                            <th class="p-3 text-red-500">Not Paid</th>
                            <th class="p-3">Assigned Flats</th>
                            <th class="p-3 text-orange-500">Allotment</th>
                            <th class="p-3 text-blue-500">Gap</th>
                    ...
                    <tbody>
                        @foreach ($districtData as $row)
                            @php
                                $gap = $row->TotalAllotment - $row->TotalPaid;
                            @endphp

                            <tr class="border-t hover:bg-gray-50">
                                <td class="p-3 font-medium">{{ $row->DistrictName }}</td>
                                <td class="p-3 text-center">{{ $row->TotalVillages }}</td>
                                <td class="p-3 text-center">{{ $row->TotalBeneficiaries }}</td>
                                <td class="p-3 text-center text-green-600 font-semibold">{{ $row->TotalPaid }}</td>
                                <td class="p-3 text-center text-red-600 font-semibold">{{ $row->TotalNotPaid }}</td>
                                <td class="p-3 text-center">{{ $row->TotalAssignedFlats }}</td>
                                <td class="p-3 text-center text-orange-600 font-bold">{{ $row->TotalAllotment }}</td>
                                <td class="p-3 text-center font-bold text-blue-600">{{ $gap }}</td>
                ...
                <div class="p-4 border-t bg-gray-50">
                    {{ $districtData->links('pagination::tailwind') }}
                </div>
            </div>
