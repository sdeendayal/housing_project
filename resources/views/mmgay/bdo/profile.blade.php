...
@section('title', 'BDO Profile & Settings')
...
<main class="ml-[260px] mt-14 min-h-screen bg-[#f3f6fc] p-4 flex flex-col gap-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-grow items-start">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 select-none">
                        ...
                        <span class="text-xs font-bold">{{ $bdo->name }}</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 select-none">
                        ...
                        <span class="text-xs font-bold">{{ $bdo->email }}</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 select-none">
                        ...
                        <span class="text-xs font-bold">{{ $bdo->mobile ?? 'Not Provided' }}</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 select-none">
                        ...
                        <span class="text-xs font-bold">{{ $bdo->district_name ?? 'Haryana' }}</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 select-none">
                        ...
                        <span class="text-xs font-bold">{{ $bdo->block_name ?? 'ALL BLOCKS' }}</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 select-none">
                        ...
                        <span class="text-xs font-bold">{{ $bdo->scheme ?? 'MMGAY' }}</span>
                    </div>
                </div>
        ...
        <div class="lg:col-span-5 bg-white rounded-xl shadow-sm border border-slate-100 p-5 flex flex-col">
            ...
            <form action="{{ route('mmgay.bdo.profile.change-password') }}" method="POST" class="space-y-4">
                @csrf
