...
<main class="ml-52 min-h-screen bg-slate-50 px-5 pb-8 pt-20">
    ...
    <div class="mx-auto max-w-7xl space-y-5">
        ...
        <div class="w-full rounded-2xl border border-slate-200
            ...
            <form
                method="GET"
                action="{{ route('physical-verification.eligible-caste-wise') }}"
            ...
            >
                ...
                <div class="flex items-center gap-2 lg:col-span-3">
                    ...
                    <a
                        href="{{ route('physical-verification.eligible-caste-wise') }}"
                        title="Reset Filters"
                    ...
                    <tbody>
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                <td colspan="9"
                                    class="border border-slate-300 px-4 py-8
