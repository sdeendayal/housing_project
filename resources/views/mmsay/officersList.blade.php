        ...
        <div class="max-w-container-max mx-auto space-y-md">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-slate-200">
                    ...
                    <a href="{{ route('mmsay-department-add-district-officer') }}"
...
'{{ $officer->district_id }}'
                                            ...
                                            <!-- Delete -->
                                            <button onclick="deleteOfficer({{ $officer->id }})"
    ...
    `;
            ...
            fetch("{{ route('mmsay.officer.update') }}", {
                    method: "POST",
                    headers: {
    ...
    <script>
        document.getElementById('transferOfficerForm')
            .addEventListener('submit', function(e) {
                ...
                fetch("{{ route('mmsay.officer.transfer') }}", {
        ...
        function deleteOfficer(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch("{{ route('mmsay.officer.delete') }}", {
