...
<head>
    ...
    <title>
        Property Statement - {{ $property->AssetId }}
    </title>
    ...
    <main class="sheet">
        <header class="report-header">
            ...
            <div class="text-right">
                <strong>Asset #{{ $property->AssetId }}</strong>
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card">
                ...
                <div class="summary-value {{ ($pendingAmount ?? 0) > 0 ? 'red' : 'green' }}">
        ...
        <section class="section section-card">
            <h2 class="section-title">
                Cash Receipts ({{ number_format($cashReceipts->count()) }})
            </h2>
        ...
        <section class="section section-card">
            <h2 class="section-title">
                ...
                {{ number_format($partiallyPaidEmiCount ?? 0) }} Partial,
                    ...
                    @forelse ($emiDetails as $emi)
                        ...
                        <tr>
                            ...
                            <td class="text-right green">
                                <strong>
                                    ₹{{ number_format($emi->allocated_payment ?? 0, 2) }}
                                </strong>
                            </td>

                            <td class="text-right {{ ($emi->installment_pending ?? 0) > 0 ? 'red' : '' }}">
                                ₹{{ number_format($emi->installment_pending ?? 0, 2) }}
                            </td>
                            ...
                            <td>
                                @forelse ($emi->receipt_allocations ?? [] as $allocation)
        ...
        <footer class="footer">
            <div>
                ...
                Non-EMI component: ₹{{ number_format($nonEmiComponent ?? 0, 2) }}.
