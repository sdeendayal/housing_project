    ...
    <main class="flex-grow flex items-center justify-center px-4 py-4 relative overflow-hidden">
        ...
        <div
            ...
            <div
                ...
                <!-- Decorative -->
                <div class="absolute -top-20 -left-20 w-64 h-64 bg-white/5 rounded-full blur-3xl pointer-events-none">
                </div>
            ...
            <div class="bg-slate-50 px-12 py-10 flex flex-col justify-center">
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div class="w-20 h-20 rounded-[24px] bg-blue-100 flex items-center justify-center shadow-sm">
                ...
                <form action="/mmsay.citizen.dashboard" method="GET" class="space-y-5">
                    @csrf
                    <!-- Mobile -->
                    <div>
