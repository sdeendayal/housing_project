                                ...
                                <form id="sendOtpForm" action="{{ route('citizen.login.send-otp') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group-custom d-flex">
                                            ...
                                            <input type="text" class="form-control premium-input" id="mobileInput"
                                                name="mobile" inputmode="numeric" autocomplete="tel"
                                                placeholder="Enter Mobile Number" maxlength="10" value="{{ old('mobile') }}"
                                                required>
                                        </div>
                                    </div>
        ...
        <script>
            (function() {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    if (mobile.length !== 10) {
                        showValidationAlert('Invalid Mobile',
