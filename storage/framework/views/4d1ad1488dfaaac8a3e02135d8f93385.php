...
<?php $__env->startSection('title', 'Registry Report'); ?>
    ...
    <main class="min-h-screen bg-slate-100 p-5 pt-20 ml-[260px] w-[calc(100%-260px)] overflow-x-hidden">
        ...
        <div class="mb-5 rounded-xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
            ...
            <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <?php if(request()->filled('phase')): ?>
                        <span class="rounded-lg bg-indigo-50 px-3 py-2 text-xs font-semibold text-indigo-700">
                            Phase: <?php echo e(request('phase')); ?>

                        </span>
                    <?php endif; ?>

                    <?php if(request()->filled('district_id')): ?>
                        <span class="rounded-lg bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-700">
                            District ID: <?php echo e(request('district_id')); ?>

                        </span>
                    <?php endif; ?>

                    <?php if(request()->filled('block_id')): ?>
                        <span class="rounded-lg bg-cyan-50 px-3 py-2 text-xs font-semibold text-cyan-700">
                            Block ID: <?php echo e(request('block_id')); ?>

                        </span>
                    <?php endif; ?>

                    <?php if(request()->filled('village_id')): ?>
                        <span class="rounded-lg bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-700">
                            Village ID: <?php echo e(request('village_id')); ?>

                        </span>
                    <?php endif; ?>

                    <a href="<?php echo e(route('admin.registration.export.excel', $exportFilters)); ?>"
                    ...
                    <a href="<?php echo e(route('admin.registration.export.pdf', $exportFilters)); ?>"
                    ...
                    <a href="<?php echo e(route('admin.registration')); ?>"
        ...
        <div class="mb-2 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div
                ...
                <?php echo e(number_format($totalRegistrations ?? 0)); ?>

                =
                <?php echo e(number_format($uniqueRegistrations ?? 0)); ?>

                +
                <?php echo e(number_format($duplicateRegistrations ?? 0)); ?>

                +
                <?php echo e(number_format($blankRegistryNumbers ?? 0)); ?>
        ...
        <div class="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <a href="<?php echo e($cardUrl('all')); ?>"
                class="group rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'all' ? 'border-blue-500 ring-2 ring-blue-100' : 'border-slate-200'); ?>">
            ...
            <a href="<?php echo e($cardUrl('unique_registry')); ?>"
                class="group rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'unique_registry' ? 'border-emerald-500 ring-2 ring-emerald-100' : 'border-slate-200'); ?>">
            ...
            <a href="<?php echo e($cardUrl('duplicate_registry')); ?>"
                class="group rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'duplicate_registry' ? 'border-amber-500 ring-2 ring-amber-100' : 'border-slate-200'); ?>">
            ...
            <a href="<?php echo e($cardUrl('blank_registry')); ?>"
                class="group rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'blank_registry' ? 'border-slate-500 ring-2 ring-slate-200' : 'border-slate-200'); ?>">
        ...
        <div class="mb-2 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div
                ...
                =
                <?php echo e(number_format($matchedRegistrations ?? 0)); ?>

                +
                <?php echo e(number_format($unmatchedRegistrations ?? 0)); ?>
        ...
        <div class="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <a href="<?php echo e($cardUrl('matched')); ?>"
                class="rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'matched' ? 'border-indigo-500 ring-2 ring-indigo-100' : 'border-slate-200'); ?>">
            ...
            <a href="<?php echo e($cardUrl('unmatched')); ?>"
                class="rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'unmatched' ? 'border-rose-500 ring-2 ring-rose-100' : 'border-slate-200'); ?>">
            ...
            <a href="<?php echo e($cardUrl('unique_matched_mobile')); ?>"
                class="rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'unique_matched_mobile' ? 'border-cyan-500 ring-2 ring-cyan-100' : 'border-slate-200'); ?>">
                ...
                <div class="flex items-start justify-between gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-2xl font-bold text-cyan-600">
                            <?php echo e(number_format($uniqueMatchedMobiles ?? 0)); ?>
            ...
            <a href="<?php echo e($cardUrl('repeated_matched_mobile')); ?>"
                class="rounded-xl border bg-white p-3.5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md
            <?php echo e($activeType === 'repeated_matched_mobile' ? 'border-orange-500 ring-2 ring-orange-100' : 'border-slate-200'); ?>">
                ...
                <div class="flex items-start justify-between gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-2xl font-bold text-orange-600">
                            <?php echo e(number_format($repeatedMatchedMobileRows ?? 0)); ?>
        ...
        <div class="mb-5 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <form method="GET" action="<?php echo e(route('admin.registration')); ?>"
                class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-6">

                <input type="hidden" name="type" value="<?php echo e($activeType); ?>">

                <?php if(request()->filled('phase')): ?>
                    <input type="hidden" name="phase" value="<?php echo e(request('phase')); ?>">
                <?php endif; ?>

                <?php if(request()->filled('district_id')): ?>
                    <input type="hidden" name="district_id" value="<?php echo e(request('district_id')); ?>">
                <?php endif; ?>

                <?php if(request()->filled('block_id')): ?>
                    <input type="hidden" name="block_id" value="<?php echo e(request('block_id')); ?>">
                <?php endif; ?>
                ...
                <div class="flex items-end">
                    ...
                    <a href="<?php echo e($resetSearchUrl); ?>"
            ...
            <?php if(request()->filled('phase') ||
                ...
                <div class="mt-3 flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 pt-3">
                    ...
                    <a href="<?php echo e(route('admin.registration', ['type' => $activeType])); ?>"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-orange-900">
                            <?php echo e($activeLabel); ?>

                        </p>

                        <p class="mt-0.5 text-xs text-orange-700">
                            <?php echo e(number_format($filteredRegistrations ?? $registrations->total())); ?>
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500">
                        Showing <?php echo e($registrations->firstItem() ?? 0); ?>

                        to <?php echo e($registrations->lastItem() ?? 0); ?>

                        of <?php echo e(number_format($registrations->total())); ?> records
                    </p>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <span
                        ...
                        <?php echo e(number_format($registrations->total())); ?> rows
                    </span>

                    <a href="<?php echo e(route('admin.registration.export.excel', $currentFilters)); ?>"
                    ...
                    <a href="<?php echo e(route('admin.registration.export.pdf', $currentFilters)); ?>"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr class="transition hover:bg-slate-50">
                                ...
                                <td class="whitespace-nowrap px-3 py-3 text-sm text-slate-600">
                                    <?php echo e(($registrations->firstItem() ?? 1) + $loop->index); ?>
                                ...
                                <td class="whitespace-nowrap px-3 py-3">
                                    ...
                                    <p class="text-sm font-semibold text-slate-800">
                                        <?php echo e($registration->RegistrationNo ?? '-'); ?>

                                    </p>

                                    <p class="mt-0.5 text-[11px] text-slate-500">
                                        Owner ID: <?php echo e($registration->OwnerId ?? '-'); ?>
                                ...
                                <td class="min-w-[210px] px-3 py-3">
                                    ...
                                    <p class="text-sm font-semibold text-slate-800">
                                        <?php echo e($registration->OwnerName ?? 'Owner not matched'); ?>

                                    </p>

                                    <p class="mt-0.5 text-xs text-slate-500">
                                        <?php echo e($registration->FatherHusbandName ?? '-'); ?>

                                    </p>

                                    <?php if(!empty($registration->PPPId)): ?>
                                        <p class="mt-0.5 text-[11px] text-slate-400">
                                            PPP ID: <?php echo e($registration->PPPId); ?>

                                        </p>
                                    <?php endif; ?>

                                    <?php if(!empty($registration->MemberId)): ?>
                                        <p class="mt-0.5 text-[11px] text-slate-400">
                                            Member ID: <?php echo e($registration->MemberId); ?>
                                ...
                                <td class="min-w-[220px] px-3 py-3">
                                    ...
                                    <p class="text-sm font-semibold text-slate-800">
                                        <?php echo e($registration->SecondParty ?? '-'); ?>

                                    </p>

                                    <p class="mt-0.5 text-xs text-slate-500">
                                        First party: <?php echo e($registration->FirstParty ?? '-'); ?>
                                ...
                                <td class="whitespace-nowrap px-3 py-3">
                                    ...
                                    <?php if(!empty($registration->SecondPartyMobile)): ?>
                                        <span
                                            ...
                                            <?php echo e($registration->SecondPartyMobile); ?>
                                ...
                                <td class="whitespace-nowrap px-3 py-3">
                                    ...
                                    <p class="text-sm font-semibold text-slate-800">
                                        <?php echo e(filled($registration->RegistaryNumber) ? $registration->RegistaryNumber : 'Missing'); ?>

                                    </p>

                                    <p class="mt-0.5 text-[11px] text-slate-500">

                                        <?php if(!empty($registration->RegistaryDate)): ?>
                                            <?php echo e(\Carbon\Carbon::parse($registration->RegistaryDate)->format('d-m-Y')); ?>
                                    ...
                                    <?php if(($registration->registry_group_count ?? 0) > 1): ?>
                                        <span
                                            class="mt-1 inline-flex rounded-md bg-amber-50 px-2 py-0.5 text-[10px] font-semibold text-amber-700">
                                            <?php echo e($registration->registry_group_count); ?> registry rows
                                        </span>
                                    <?php endif; ?>
                                ...
                                <td class="whitespace-nowrap px-3 py-3">
                                    ...
                                    <p class="text-xs font-semibold text-slate-700">
                                        Token: <?php echo e($registration->Token ?? '-'); ?>

                                    </p>

                                    <p class="mt-0.5 text-[11px] text-slate-500">
                                        Khewat: <?php echo e($registration->Khewat ?? '-'); ?>
                                ...
                                <td class="whitespace-nowrap px-3 py-3">
                                    ...
                                    <p class="text-xs font-semibold text-slate-800">
                                        Transfer: <?php echo e($registration->TransferArea ?? '-'); ?>

                                    </p>

                                    <p class="mt-0.5 text-[11px] text-slate-500">
                                        Total: <?php echo e($registration->TotalArea ?? '-'); ?>

                                    </p>

                                    <?php if(!empty($registration->Bhag)): ?>
                                        <p class="mt-0.5 text-[11px] text-slate-400">
                                            Share: <?php echo e($registration->Bhag); ?>
                                ...
                                <td class="min-w-[190px] px-3 py-3">
                                    ...
                                    <p class="text-sm font-semibold text-slate-800">
                                        <?php echo e($registration->Village ?? '-'); ?>

                                    </p>

                                    <p class="mt-0.5 text-xs text-slate-500">
                                        <?php echo e($registration->TehsilName ?? '-'); ?>,
                                        <?php echo e($registration->District ?? '-'); ?>
                                ...
                                <td class="whitespace-nowrap px-3 py-3">
                                    ...
                                    <?php if(!empty($registration->OwnerId)): ?>
                                        <span
                                        ...
                                        <?php if(!empty($registration->Phase)): ?>
                                            <p class="mt-1 text-center text-[10px] font-semibold text-indigo-600">
                                                Phase <?php echo e($registration->Phase); ?>
            ...
            <?php if($registrations->hasPages()): ?>
                <div class="border-t border-slate-200 px-4 py-3">
                    <?php echo e($registrations->onEachSide(1)->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layouts.mmgayAdmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\housing-project\resources\views/mmgay/super-admin/registration.blade.php ENDPATH**/ ?>