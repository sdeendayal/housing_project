<?php $__env->startSection('title', 'Phase Wise Drill-Down Analytics'); ?>
<?php $__env->startSection('page_header', 'Phase Analytics'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-3.5 flex items-center gap-2">
        ...
        <div class="flex gap-2">
            <?php $__currentLoopData = $phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phaseVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('mmgay.bdo.phase-report')); ?>?phase=<?php echo e($phaseVal); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-4 flex flex-col h-[calc(100vh-170px)] min-h-[550px] overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto space-y-1.5 pr-1">
                <?php $__empty_1 = true; $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('mmgay.bdo.phase-report')); ?>?phase=<?php echo e($selectedPhase); ?>&village_id=<?php echo e($vil->VillageId); ?>" 
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-slate-100 p-4 flex flex-col h-[calc(100vh-170px)] min-h-[550px] overflow-hidden">
            ...
            <?php else: ?>
                <div class="pb-3 border-b border-slate-100 mb-3 flex items-center justify-between">
                    <div>
                        <h3 class="text-xs font-extrabold text-slate-800 uppercase tracking-wider flex items-center gap-1.5">
                            ...
                            Beneficiaries: <?php echo e($selectedVillageName); ?>
                ...
                <div class="mb-4 pb-3 border-b border-slate-100">
                    <form action="<?php echo e(route('mmgay.bdo.phase-report')); ?>" method="GET" class="flex gap-2">
                        ...
                        <?php if($search): ?>
                            <a href="<?php echo e(route('mmgay.bdo.phase-report')); ?>?phase=<?php echo e($selectedPhase); ?>&village_id=<?php echo e($selectedVillageId); ?>" class="bg-slate-100 hover:bg-slate-200 text-slate-700 px-3 py-1.5 rounded-lg text-xs font-bold flex items-center">Reset</a>
                        <?php endif; ?>
                    </form>
                </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-[11px]">
                                            <div class="space-y-2">
                                                ...
                                                <div class="flex justify-between border-b border-slate-200/50 pb-1">
                                                    ...
                                                    <span class="bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded font-mono font-black text-[9px]"><?php echo e($ben->FlatNo ?: '—'); ?></span>
                                                </div>
                                                <div class="flex justify-between border-b border-slate-200/50 pb-1">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div class="flex justify-between border-b border-slate-200/50 pb-1">
                                                    ...
                                                    <span class="font-bold text-slate-700 uppercase"><?php echo e($selectedVillageName); ?> / <?php echo e($ben->BlockName); ?></span>
                                                </div>
                                                <div class="flex justify-between border-b border-slate-200/50 pb-1">
...
<?php echo $__env->make('layouts.mmgayBdoAuth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sports\housing_project\resources\views/mmgay/bdo/phase_report.blade.php ENDPATH**/ ?>