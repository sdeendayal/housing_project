...
<body class="h-full flex overflow-hidden bg-[#f4f7fa]">
    ...
    <aside class="hidden md:flex flex-col w-64 bg-slate-900 text-slate-300 shrink-0 h-full shadow-xl z-20">
        ...
        <div class="flex-1 px-4 py-6 space-y-6 overflow-y-auto custom-scroll">
            <div>
                ...
                <div class="space-y-1">
                    <a href="<?php echo e(route('ews.developer.dashboard')); ?>" id="nav-dashboard"
                        class="flex items-center gap-2.5 px-3 py-2 rounded-lg <?php echo e($currentView === 'dashboard' ? 'bg-slate-800 text-white font-bold shadow-sm' : 'text-slate-300 hover:bg-slate-800 hover:text-white font-medium'); ?> transition-all">
                        <i class="bi bi-speedometer2 text-sky-400"></i>
                        <span>Dashboard</span>
                    </a>
                    <a href="<?php echo e(route('ews.developer.dashboard', ['view' => 'district'])); ?>" id="nav-district-flats"
                        class="flex items-center gap-2.5 px-3 py-2 rounded-lg <?php echo e($currentView === 'district' ? 'bg-slate-800 text-white font-bold shadow-sm' : 'text-slate-300 hover:bg-slate-800 hover:text-white font-medium'); ?> transition-all">
                        <i class="bi bi-building text-sky-400"></i>
                        <span><?php echo e(!empty($user->district_name) ? strtoupper($user->district_name) : 'My District'); ?> Flats</span>
                    </a>
                    <a href="<?php echo e(route('ews.developer.dashboard', ['view' => 'my_flats'])); ?>" id="nav-my-flats"
                        class="flex items-center gap-2.5 px-3 py-2 rounded-lg <?php echo e($currentView === 'my_flats' ? 'bg-slate-800 text-white font-bold shadow-sm' : 'text-slate-300 hover:bg-slate-800 hover:text-white font-medium'); ?> transition-all">
                        <i class="bi bi-person-check-fill text-emerald-400"></i>
                        <span>Flats Added By Me</span>
                    </a>
                    <a href="<?php echo e(route('ews.developer.flats.create')); ?>" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white text-xs font-medium transition-all">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="<?php echo e(route('ews.developer.logs')); ?>" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white text-xs font-medium transition-all">
        ...
        <div class="p-4 border-t border-slate-800 bg-slate-950 flex flex-col gap-2 shrink-0">
            ...
            <a href="<?php echo e(route('ews.developer.logout')); ?>" class="w-full py-1.5 bg-red-500/20 hover:bg-red-600 text-red-300 rounded-lg text-[9px] font-black uppercase transition-all flex items-center justify-center gap-1 border border-red-500/30">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-xs font-black tracking-wider text-slate-800 uppercase">
                        <?php if($currentView === 'district'): ?>
                            <?php echo e($user->district_name ?? 'District'); ?> District Master Registry
                        <?php elseif($currentView === 'my_flats'): ?>
                ...
                <div class="text-right">
                    <div class="text-[10px] text-slate-700 font-bold flex items-center gap-1 justify-end">
                        ...
                        <?php if(!empty($user->district_name)): ?>
                            <span class="text-[9px] bg-sky-100 text-sky-800 font-extrabold uppercase px-1.5 py-0.5 rounded border border-sky-200">(<?php echo e(strtoupper($user->district_name)); ?>)</span>
                        <?php endif; ?>
                        <i class="bi bi-person-circle text-sky-600"></i>
                    </div>
                    <div class="text-[8.5px] text-slate-500 font-mono">
                        District: <span class="font-bold text-slate-700 uppercase"><?php echo e($user->district_name ?? 'N/A'); ?></span> | Mobile: <?php echo e($user->mobile); ?>

                    </div>
                </div>
                <a href="<?php echo e(route('ews.developer.logout')); ?>" class="md:hidden px-3 py-1.5 bg-red-50 text-red-650 rounded-lg text-[9px] font-black uppercase border border-red-100">
                    Logout
                </a>
            </div>
        </header>
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-5 custom-scroll">
            ...
            <?php if($currentView === 'dashboard'): ?>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                        <div>
                            <span class="inline-flex items-center gap-1 px-2.5 py-1 bg-sky-500/20 text-sky-300 border border-sky-500/30 rounded-md text-[9px] font-black uppercase mb-2">
                                <i class="bi bi-geo-alt-fill"></i> ASSIGNED DISTRICT: <?php echo e(strtoupper($user->district_name ?? 'ALL')); ?>

                            </span>
                            <h2 class="text-lg font-black tracking-tight text-white">Welcome, <?php echo e($user->name); ?></h2>
                            <p class="text-xs text-slate-300 mt-0.5">EWS Builder Flats Registry Console & Inventory Management Panel</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <a href="<?php echo e(route('ews.developer.flats.create')); ?>" class="px-4 py-2 bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700 text-white rounded-lg text-xs font-black uppercase tracking-wider shadow-lg flex items-center gap-1.5 transition-all">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <a href="<?php echo e(route('ews.developer.dashboard', ['view' => 'district'])); ?>" class="bg-white border border-sky-200/80 hover:border-sky-400 rounded-xl p-4 shadow-sm dev-shadow flex items-center justify-between transition-all group">
                        <div>
                            <span class="block text-[9px] font-black uppercase tracking-wider text-sky-600">District Master</span>
                            <h4 class="text-xl font-black text-sky-600 font-mono mt-0.5"><?php echo e($stats['total_flats']); ?></h4>
                            <span class="block text-[8px] text-slate-400 font-mono uppercase mt-1">Total <?php echo e($user->district_name ?? ''); ?> Flats</span>
                        </div>
                    ...
                    <a href="<?php echo e(route('ews.developer.dashboard', ['view' => 'my_flats'])); ?>" class="bg-white border border-emerald-200/80 hover:border-emerald-400 rounded-xl p-4 shadow-sm dev-shadow flex items-center justify-between transition-all group">
                        <div>
                            <span class="block text-[9px] font-black uppercase tracking-wider text-emerald-600">Personal Entries</span>
                            <h4 class="text-xl font-black text-emerald-600 font-mono mt-0.5"><?php echo e($stats['my_flats']); ?></h4>
                    ...
                    <a href="javascript:void(0)" onclick="openProjectsModal(event)" class="bg-white border border-indigo-200/80 hover:border-indigo-400 rounded-xl p-4 shadow-sm dev-shadow flex items-center justify-between transition-all group">
                        <div>
                            ...
                            <h4 class="text-xl font-black text-indigo-600 font-mono mt-0.5"><?php echo e($stats['total_projects']); ?></h4>
                    ...
                    <a href="javascript:void(0)" onclick="openTownsModal(event)" class="bg-white border border-violet-200/80 hover:border-violet-400 rounded-xl p-4 shadow-sm dev-shadow flex items-center justify-between transition-all group">
                        <div>
                            ...
                            <h4 class="text-xl font-black text-violet-600 font-mono mt-0.5"><?php echo e($stats['total_towns']); ?></h4>
                ...
                <div id="project-breakdown-section" class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm dev-shadow space-y-4">
                    <div class="flex items-center justify-between border-b border-slate-150 pb-3">
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="text-xs font-black uppercase text-slate-800 tracking-wider">
                                <?php echo e($user->district_name ?? 'District'); ?> EWS Projects Breakdown
                            </h3>
                        </div>
                        <span class="text-[9px] font-mono font-bold text-slate-400 uppercase">
                            <?php echo e(count($projectBreakdown)); ?> Active Project Lines
                        </span>
                    </div>

                    <?php if(count($projectBreakdown) > 0): ?>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <?php $__currentLoopData = $projectBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-slate-50 border border-slate-200 rounded-lg p-3.5 flex items-center justify-between">
                                    <div>
                                        <div class="text-[9px] font-black uppercase text-slate-400 tracking-wider"><?php echo e($project->town_name); ?></div>
                                        <div class="text-xs font-bold text-slate-900 mt-0.5"><?php echo e($project->project_name); ?></div>
                                        <div class="text-[8px] text-slate-500 font-mono mt-1">Towers: <?php echo e($project->towers_count); ?> Blocks</div>
                                    </div>
                                    <div class="text-right">
                                        <span class="px-2.5 py-1 bg-sky-100 text-sky-800 font-black font-mono rounded-md text-xs">
                                            <?php echo e($project->total_flats); ?> Flats
                                        </span>
                                    </div>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="text-center py-6 text-slate-400 text-xs italic">
                            No EWS builder projects registered yet in <?php echo e($user->district_name ?? 'District'); ?>.
                        </div>
                    <?php endif; ?>
                </div>
            <?php elseif($currentView === 'district'): ?>
                <!-- DISTRICT FLATS VIEW -->
                <div class="bg-gradient-to-r from-sky-600 to-indigo-700 rounded-xl p-5 text-white shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <h2 class="text-base font-black uppercase tracking-wider"><?php echo e($user->district_name ?? 'District'); ?> Master EWS Flats</h2>
                        <p class="text-[9px] text-sky-100 font-mono">Viewing all allotment proforma flats registered under <?php echo e($user->district_name); ?> District Authority</p>
                    </div>
                    <div class="text-right">
                        <span class="text-3xl font-black font-mono"><?php echo e($stats['total_flats']); ?></span>
            ...
            <?php elseif($currentView === 'my_flats'): ?>
                ...
                <div class="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-xl p-5 text-white shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-[9px] text-emerald-100 font-mono">Viewing flats created directly by your developer account (ID: #<?php echo e($user->id); ?>)</p>
                    </div>
                    <div class="text-right">
                        <span class="text-3xl font-black font-mono"><?php echo e($stats['my_flats']); ?></span>
                        ...
                        <h3 class="text-xs font-black uppercase tracking-wider text-slate-800 flex items-center gap-2">
                            ...
                            <?php if(!empty($user->district_name)): ?>
                                <span class="px-2 py-0.5 bg-sky-100 text-sky-800 border border-sky-200 rounded text-[9px] font-black uppercase">
                                    <i class="bi bi-geo-alt-fill me-0.5"></i> <?php echo e(strtoupper($user->district_name)); ?>
                    ...
                    <div class="flex flex-wrap items-center gap-2.5 self-end sm:self-auto">
                        ...
                        <div class="inline-flex bg-slate-200/80 p-0.5 rounded-lg text-[10px] font-bold">
                            <button type="button" id="btn-scope-all" onclick="setOwnershipFilter('all')"
                                class="px-3 py-1 rounded-md transition-all uppercase tracking-wider <?php echo e($currentView === 'my_flats' ? 'text-slate-600 font-bold' : 'bg-white text-sky-700 shadow-sm font-black'); ?>">
                                <i class="bi bi-building me-1"></i> All <?php echo e($user->district_name ?? 'District'); ?> Records
                            </button>
                            <button type="button" id="btn-scope-my" onclick="setOwnershipFilter('my_flats')"
                                class="px-3 py-1 rounded-md transition-all uppercase tracking-wider <?php echo e($currentView === 'my_flats' ? 'bg-white text-emerald-700 shadow-sm font-black' : 'text-slate-600 font-bold'); ?>">
                                <i class="bi bi-person-check-fill me-1"></i> Added By Me Only
                            </button>
                        </div>

                        <input type="hidden" id="filter-ownership" value="<?php echo e($currentView === 'my_flats' ? 'my_flats' : 'all'); ?>">
                        ...
                        <a href="<?php echo e(route('ews.developer.flats.create')); ?>"
        ...
        <div class="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-100 flex flex-col max-h-[80vh] overflow-hidden transform scale-95 opacity-0 transition-all duration-300" id="projects-modal-content">
            ...
            <div class="px-6 py-4 border-b border-slate-150 flex items-center justify-between bg-slate-50">
                <div class="flex items-center gap-2 text-indigo-700">
                    <i class="bi bi-diagram-3-fill text-lg"></i>
                    <h3 class="text-xs font-black uppercase tracking-wider text-slate-800">Projects in <?php echo e(strtoupper($user->district_name ?? 'District')); ?></h3>
                </div>
            ...
            <div class="p-6 overflow-y-auto space-y-2 flex-1 custom-scroll">
                <?php $__empty_1 = true; $__currentLoopData = $projectsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="px-4 py-3 bg-slate-50 border border-slate-150 rounded-xl flex items-center justify-between hover:bg-slate-100/70 transition-all">
                        <span class="text-xs font-bold text-slate-700"><?php echo e($index + 1); ?>. <?php echo e(strtoupper($proj->name)); ?></span>
                        <span class="px-2 py-0.5 bg-indigo-50 text-indigo-700 border border-indigo-150 rounded text-[9px] font-mono font-bold uppercase">
                            <?php echo e(DB::table('ews_builder_flats')->where('project_id', $proj->id)->count()); ?> Flats
                        </span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-6 text-slate-400 text-xs font-medium">No projects registered in <?php echo e($user->district_name); ?>.</div>
                <?php endif; ?>
            </div>
            <!-- Footer -->
        ...
        <div class="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-100 flex flex-col max-h-[80vh] overflow-hidden transform scale-95 opacity-0 transition-all duration-300" id="towns-modal-content">
            ...
            <div class="px-6 py-4 border-b border-slate-150 flex items-center justify-between bg-slate-50">
                <div class="flex items-center gap-2 text-violet-750">
                    <i class="bi bi-pin-map-fill text-lg"></i>
                    <h3 class="text-xs font-black uppercase tracking-wider text-slate-800">Towns in <?php echo e(strtoupper($user->district_name ?? 'District')); ?></h3>
                </div>
            ...
            <!-- Body -->
            <div class="p-6 overflow-y-auto space-y-2 flex-1 custom-scroll">
                <?php $__empty_1 = true; $__currentLoopData = $townsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $town): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="px-4 py-3 bg-slate-50 border border-slate-150 rounded-xl flex items-center justify-between hover:bg-slate-100/70 transition-all">
                        <span class="text-xs font-bold text-slate-700"><?php echo e($index + 1); ?>. <?php echo e(strtoupper($town->name)); ?></span>
                        <span class="px-2 py-0.5 bg-violet-50 text-violet-700 border border-violet-150 rounded text-[9px] font-mono font-bold uppercase">
                            <?php echo e(DB::table('ews_builder_flats')->where('town_id', $town->id)->count()); ?> Flats
                        </span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-6 text-slate-400 text-xs font-medium">No towns mapped in <?php echo e($user->district_name); ?>.</div>
                <?php endif; ?>
            </div>
            <!-- Footer -->
            <div class="px-6 py-3 bg-slate-50 border-t border-slate-150 text-right">
    ...
    <script>
        ...
        function triggerExport(type) {
            ...
            let baseUrl = '';
            if (type === 'csv') baseUrl = "<?php echo e(route('ews.developer.flats.export.csv')); ?>";
            else if (type === 'excel') baseUrl = "<?php echo e(route('ews.developer.flats.export.excel')); ?>";
            else if (type === 'pdf') baseUrl = "<?php echo e(route('ews.developer.flats.export.pdf')); ?>";
        ...
        $(document).ready(function() {
            table = $('#flats-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('ews.developer.flats.data')); ?>",
                    data: function (d) {
            ...
            $('#export-csv').on('click', function(e) {
                ...
                let url = "<?php echo e(route('ews.developer.flats.export.csv')); ?>?search=" + encodeURIComponent(search) + "&district_id=" + districtId;
            ...
            $('#export-pdf').on('click', function(e) {
                ...
                let search = $('#flats-table_filter input').val() || '';
                let districtId = $('#filter-district').val() || '';
                let url = "<?php echo e(route('ews.developer.flats.export.pdf')); ?>?search=" + encodeURIComponent(search) + "&district_id=" + districtId;
                window.location.href = url;
            });
        });
    </script>
...
<?php /**PATH E:\sports\housing_project\resources\views/ews/developer/dashboard.blade.php ENDPATH**/ ?>