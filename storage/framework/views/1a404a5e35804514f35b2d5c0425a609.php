        ...
        <section class="w-full md:w-1/2 flex flex-col justify-center items-center relative login-bg-pattern px-6 md:px-12 py-6 overflow-y-auto h-full">
            ...
            <div class="w-full max-w-md z-10">
                ...
                <div class="bg-white/95 backdrop-blur-xl rounded-2xl shadow-[0_15px_45px_rgba(0,88,188,0.12)] border border-slate-100 p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('mmgay.bdo.login.submit')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', 'bdporewari@gmail.com')); ?>" placeholder="bdporewari@gmail.com" class="w-full h-[40px] pl-10 pr-3 border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-[#0058bc]/20 focus:border-[#0058bc] focus:outline-none transition-all <?php $__errorArgs = ['email'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="text-red-500 text-xs mt-0.5"><?php echo e($message); ?></p>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <input id="password" type="password" name="password" value="123456" placeholder="••••••••" class="w-full h-[40px] pl-10 pr-10 border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-[#0058bc]/20 focus:border-[#0058bc] focus:outline-none transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="flex gap-2">
                                ...
                                <input type="text" name="captcha" placeholder="Enter Captcha" class="flex-1 min-w-0 h-[40px] px-3 border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-[#0058bc]/20 focus:border-[#0058bc] focus:outline-none transition-all <?php $__errorArgs = ['captcha'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-100 text-center">
                        ...
                        <a href="<?php echo e(route('mmgay.login')); ?>" class="inline-flex items-center gap-1 text-xs font-semibold text-[#0058bc] hover:underline">
    ...
    <script>
        ...
        if (refreshCaptcha) {
            refreshCaptcha.addEventListener('click', function() {
                fetch('<?php echo e(route("mmgay.bdo.refresh.captcha")); ?>')
...
<?php /**PATH E:\sports\housing_project\resources\views/mmgay/bdo/login.blade.php ENDPATH**/ ?>