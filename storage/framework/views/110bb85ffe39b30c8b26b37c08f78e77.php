    ...
    <div class="w-full max-w-5xl h-full max-h-[85vh] bg-white border border-slate-200 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-2xl dev-shadow z-10">
        ...
        <div class="w-full md:w-7/12 h-full flex flex-col justify-between p-6 sm:p-8 bg-white relative overflow-y-auto custom-scroll">
            ...
            <div class="w-full max-w-sm mx-auto space-y-4 my-auto">
                ...
                <form method="POST" action="<?php echo e(route('ews.developer.login.send-otp')); ?>" class="space-y-3" id="devLoginForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-slate-250 bg-slate-50 focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-500 transition-all">
                            ...
                            <input type="text" id="mobile" name="mobile" maxlength="10" placeholder="9999999999" value="<?php echo e(old('mobile', '9999999999')); ?>"
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="space-y-1.5 flex flex-col justify-end">
                            <div class="bg-slate-50 border border-slate-200 rounded-lg h-9 flex items-center justify-center font-mono font-bold tracking-widest text-slate-800 relative overflow-hidden select-none border-dashed border-amber-500/30 text-xs">
                                <span class="tracking-widest font-black text-amber-600"><?php echo e($captcha); ?></span>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH E:\sports\housing_project\resources\views/ews/developer/login.blade.php ENDPATH**/ ?>