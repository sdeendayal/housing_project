...
<?php $__env->startSection('title', 'MMGAV Villager Login'); ?>
   ...
   body.page-citizen-login footer .flex.justify-center.items-center.gap-6.mt-4 {
    ...
    .cl-page {
       ...
       background:
          ...
          url('<?php echo e(asset('images/citizen-login/gramin_bg.png')); ?>') center / cover no-repeat;
    }
      ...
      <div class="cl-card">
         <div class="cl-brand">
            <div class="cl-brand__icon">
             ...
             <div>
                <p class="cl-brand__title">Housing For All (<?php echo e((isset($context) && str_contains($context, 'mmgav')) || str_contains(request()->url(), 'mmgav') ? 'MMGAV' : 'MMGAY'); ?>)</p>
         ...
         <div class="cl-body">
            ...
            <form id="sendOtpForm" action="<?php echo e(route('mmgav.villager.login.send-otp')); ?>" method="POST">
               <?php echo csrf_field(); ?>
               ...
               <div class="cl-field">
                  ...
                  <div class="cl-captcha">
                     <div class="cl-captcha__box" id="captchaText"><?php echo e($captcha); ?></div>
                     <div
                        role="button"
                        tabindex="0"
...
(function () {
   ...
   <?php if($errors->any()): ?>
      showErrorAlert('Validation Error', <?php echo json_encode($errors->first(), 15, 512) ?>);
   <?php elseif(session('error')): ?>
      showErrorAlert('Unable to Send OTP', <?php echo json_encode(session('error'), 15, 512) ?>);
   <?php elseif(session('info')): ?>
      showValidationAlert('Villager Login', <?php echo json_encode(session('info'), 15, 512) ?>);
   <?php endif; ?>
})();
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sports\housing_project\resources\views/mmgay/citizenLogin.blade.php ENDPATH**/ ?>