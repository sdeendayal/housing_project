<?php $__env->startSection('title', 'Department of Housing For All - Home'); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="h-[360px] overflow-hidden relative">
                        ...
                        <ul id="newsScroller"
                            ...
                            <li class="p-3 hover:bg-slate-50">
                                <a class="flex items-start space-x-2" href="<?php echo e(route('citizen.login')); ?>">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <a href="<?php echo e(route('citizen.login')); ?>"
                            ...
                            <a href="<?php echo e(route('pp.department.login')); ?>"
                                class="flex items-center gap-2 px-4 py-3 hover:bg-blue-50 text-sm font-medium text-gray-700 transition-all border-t border-gray-100">
                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <a href="<?php echo e(route('mmgay.login')); ?>"
                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <a href="<?php echo e(route('ews.citizen.login')); ?>"
                            ...
                            <a href="<?php echo e(route('ews.developer.login')); ?>"
                            ...
                            <a href="<?php echo e(route('ews.department.login')); ?>"
                                class="flex items-center gap-2 px-4 py-3 hover:bg-orange-50 text-sm font-medium text-gray-700 transition-all border-t border-gray-100">
                        ...
                        <div id="slider" class="flex gap-4 transition-transform duration-700 ease-in-out">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="min-w-full flex justify-center">
                                    <img src="<?php echo e(!empty($banner->image) ? asset('uploads/banner/' . $banner->image) : asset('banner.jpeg')); ?>"
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="min-w-full flex justify-center">
                                    <img src="<?php echo e(asset('banner.jpeg')); ?>"
                                        class="w-full rounded-xl object-cover transition-transform duration-500 hover:scale-[1.01]"
                                        alt="Default Banner">
                                </div>
                            <?php endif; ?>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-surface-container-highest overflow-hidden">
                    ...
                    <div class="divide-y divide-surface-container-low max-h-48 overflow-y-auto custom-scroll">
                        <div class="p-3 flex items-start space-x-3">
                            ...
                            <div>
                                <div class="text-[10px] text-on-surface-variant mb-0.5"><?php echo e(now()->format('d M, Y')); ?></div>
            ...
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="grid md:grid-cols-4 gap-6">
                    ...
                    <div class="group rounded-3xl overflow-hidden shadow-lg">
                        <img src="<?php echo e(asset('1654693046606798243.jpg')); ?>"
                            class="h-64 w-full object-cover group-hover:scale-110 transition duration-500"
                            alt="Gallery Image">
                    </div>

                    <div class="group rounded-3xl overflow-hidden shadow-lg">
                        <img src="<?php echo e(asset('16546930511289561504.jpg')); ?>"
                            class="h-64 w-full object-cover group-hover:scale-110 transition duration-500"
                            alt="Gallery Image">
                    </div>

                    <div class="group rounded-3xl overflow-hidden shadow-lg">
                        <img src="<?php echo e(asset('16546930602025626684.jpg')); ?>"
                            class="h-64 w-full object-cover group-hover:scale-110 transition duration-500"
                            alt="Gallery Image">
                    </div>

                    <div class="group rounded-3xl overflow-hidden shadow-lg">
                        <img src="<?php echo e(asset('1654693080605359150.jpg')); ?>"
                            class="h-64 w-full object-cover group-hover:scale-110 transition duration-500"
                            alt="Gallery Image">
                    </div>
    ...
    <?php echo $__env->make('partials.rightSidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\housing-project\resources\views/home/index.blade.php ENDPATH**/ ?>