                    ...
                    <form method="POST" action="<?php echo e(route('mmgay.bdo.login.submit')); ?>" class="space-y-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', 'bdo@mmgay.com')); ?>" placeholder="bdo@mmgay.com" class="w-full h-[40px] pl-10 pr-3 border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-[#0058bc]/20 focus:border-[#0058bc] focus:outline-none transition-all <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <input id="password" type="password" name="password" value="password123" placeholder="••••••••" class="w-full h-[40px] pl-10 pr-10 border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-[#0058bc]/20 focus:border-[#0058bc] focus:outline-none transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php /**PATH D:\xampp\htdocs\housing-project\resources\views/mmgay/bdo/login.blade.php ENDPATH**/ ?>