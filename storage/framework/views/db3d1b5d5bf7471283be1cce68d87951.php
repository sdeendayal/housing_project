<?php $__env->startSection('title', 'Site Development Works'); ?>
<?php $__env->startSection('page_header', 'Site Development'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-3.5 flex items-center gap-2">
        ...
        <div class="flex gap-2">
            <?php $__currentLoopData = $phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phaseVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('mmgay.bdo.site-development')); ?>?phase=<?php echo e($phaseVal); ?>&village_id=<?php echo e($selectedVillageId); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-4 flex flex-col h-[calc(100vh-340px)] min-h-[480px] overflow-hidden">
            ...
            <div class="flex-grow overflow-y-auto space-y-1.5 pr-1">
                <?php $__empty_1 = true; $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('mmgay.bdo.site-development')); ?>?village_id=<?php echo e($vil->VillageId); ?>&phase=<?php echo e($selectedPhase); ?>" 
                       ...
                       <?php echo e($selectedVillageId == $vil->VillageId ? 'bg-blue-50 border-blue-200 text-blue-800 font-bold' : 'bg-slate-50 border-slate-150 text-slate-700 hover:bg-slate-100/70'); ?>">
                        <div class="flex items-center gap-2">
                            <span class="material-symbols-outlined text-base <?php echo e($selectedVillageId == $vil->VillageId ? 'text-blue-600' : 'text-slate-400'); ?>">location_on</span>
                            <span class="text-xs uppercase tracking-wide"><?php echo e($vil->VillageName); ?></span>
                        </div>
                        <span class="material-symbols-outlined text-sm <?php echo e($selectedVillageId == $vil->VillageId ? 'text-blue-600' : 'text-slate-300'); ?>">chevron_right</span>
                    </a>
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-slate-100 p-4 flex flex-col h-[calc(100vh-340px)] min-h-[480px] overflow-hidden">
            ...
            <?php else: ?>
                <div class="pb-2.5 border-b border-slate-100 mb-3 flex items-center justify-between">
                    <div>
                        <h3 class="text-xs font-extrabold text-slate-800 uppercase tracking-wider flex items-center gap-1.5">
                            ...
                            Development Status: <?php echo e($selectedVillageName); ?> (Phase <?php echo e($selectedPhase); ?>)
                        </h3>
                ...
                <div class="flex-grow overflow-y-auto pr-1">
                    <form action="<?php echo e(route('mmgay.bdo.site-development.save')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="bg-slate-50 border border-slate-150 rounded-xl p-3 flex flex-col justify-between">
                                <div>
                                    ...
                                    <select name="road_status" class="w-full text-xs border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 font-semibold text-slate-700 bg-white mb-2.5">
                                        <option value="" <?php echo e(old('road_status', $siteDev->road_status ?? '') === '' ? 'selected' : ''); ?>>Select</option>
                                        <option value="Not Started" <?php echo e(old('road_status', $siteDev->road_status ?? '') == 'Not Started' ? 'selected' : ''); ?>>Not Started</option>
                                        <option value="Work in Progress" <?php echo e(old('road_status', $siteDev->road_status ?? '') == 'Work in Progress' ? 'selected' : ''); ?>>Work in Progress</option>
                                        <option value="Completed" <?php echo e(old('road_status', $siteDev->road_status ?? '') == 'Completed' ? 'selected' : ''); ?>>Completed</option>
                                    </select>
                                ...
                                <?php if(isset($siteDev->road_photo)): ?>
                                    <?php $roadPhotoUrl = str_starts_with($siteDev->road_photo, 'uploads/') ? asset($siteDev->road_photo) : asset('storage/' . $siteDev->road_photo); ?>
                                    <div class="mt-3 relative rounded-lg overflow-hidden border border-slate-200 aspect-[16/9] bg-black">
                                        <a href="<?php echo e($roadPhotoUrl); ?>" data-lightbox="site-development" data-title="Road Connectivity Progress Photo">
                                            <img src="<?php echo e($roadPhotoUrl); ?>" alt="Road Progress" class="w-full h-full object-cover cursor-zoom-in">
                                        </a>
                            ...
                            <div class="bg-slate-50 border border-slate-150 rounded-xl p-3 flex flex-col justify-between">
                                <div>
                                    ...
                                    <select name="water_status" class="w-full text-xs border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 font-semibold text-slate-700 bg-white mb-2.5">
                                        <option value="" <?php echo e(old('water_status', $siteDev->water_status ?? '') === '' ? 'selected' : ''); ?>>Select</option>
                                        <option value="Not Started" <?php echo e(old('water_status', $siteDev->water_status ?? '') == 'Not Started' ? 'selected' : ''); ?>>Not Started</option>
                                        <option value="Work in Progress" <?php echo e(old('water_status', $siteDev->water_status ?? '') == 'Work in Progress' ? 'selected' : ''); ?>>Work in Progress</option>
                                        <option value="Completed" <?php echo e(old('water_status', $siteDev->water_status ?? '') == 'Completed' ? 'selected' : ''); ?>>Completed</option>
                                    </select>
                                ...
                                <?php if(isset($siteDev->water_photo)): ?>
                                    <?php $waterPhotoUrl = str_starts_with($siteDev->water_photo, 'uploads/') ? asset($siteDev->water_photo) : asset('storage/' . $siteDev->water_photo); ?>
                                    <div class="mt-3 relative rounded-lg overflow-hidden border border-slate-200 aspect-[16/9] bg-black">
                                        <a href="<?php echo e($waterPhotoUrl); ?>" data-lightbox="site-development" data-title="Drinking Water Supply (PHED) Progress Photo">
                                            <img src="<?php echo e($waterPhotoUrl); ?>" alt="Water Progress" class="w-full h-full object-cover cursor-zoom-in">
                                        </a>
                            ...
                            <div class="bg-slate-50 border border-slate-150 rounded-xl p-3 flex flex-col justify-between">
                                <div>
                                    ...
                                    <select name="electricity_status" class="w-full text-xs border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 font-semibold text-slate-700 bg-white mb-2.5">
                                        <option value="" <?php echo e(old('electricity_status', $siteDev->electricity_status ?? '') === '' ? 'selected' : ''); ?>>Select</option>
                                        <option value="Not Started" <?php echo e(old('electricity_status', $siteDev->electricity_status ?? '') == 'Not Started' ? 'selected' : ''); ?>>Not Started</option>
                                        <option value="Work in Progress" <?php echo e(old('electricity_status', $siteDev->electricity_status ?? '') == 'Work in Progress' ? 'selected' : ''); ?>>Work in Progress</option>
                                        <option value="Completed" <?php echo e(old('electricity_status', $siteDev->electricity_status ?? '') == 'Completed' ? 'selected' : ''); ?>>Completed</option>
                                    </select>
                                ...
                                <?php if(isset($siteDev->electricity_photo)): ?>
                                    <?php $electricityPhotoUrl = str_starts_with($siteDev->electricity_photo, 'uploads/') ? asset($siteDev->electricity_photo) : asset('storage/' . $siteDev->electricity_photo); ?>
                                    <div class="mt-3 relative rounded-lg overflow-hidden border border-slate-200 aspect-[16/9] bg-black">
                                        <a href="<?php echo e($electricityPhotoUrl); ?>" data-lightbox="site-development" data-title="Street Light / Electrical Progress Photo">
                                            <img src="<?php echo e($electricityPhotoUrl); ?>" alt="Electricity Progress" class="w-full h-full object-cover cursor-zoom-in">
                                        </a>
                            ...
                            <div class="bg-slate-50 border border-slate-150 rounded-xl p-3 flex flex-col justify-between">
                                <div>
                                    ...
                                    <select name="sewerage_status" class="w-full text-xs border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 font-semibold text-slate-700 bg-white mb-2.5">
                                        <option value="" <?php echo e(old('sewerage_status', $siteDev->sewerage_status ?? '') === '' ? 'selected' : ''); ?>>Select</option>
                                        <option value="Not Started" <?php echo e(old('sewerage_status', $siteDev->sewerage_status ?? '') == 'Not Started' ? 'selected' : ''); ?>>Not Started</option>
                                        <option value="Work in Progress" <?php echo e(old('sewerage_status', $siteDev->sewerage_status ?? '') == 'Work in Progress' ? 'selected' : ''); ?>>Work in Progress</option>
                                        <option value="Completed" <?php echo e(old('sewerage_status', $siteDev->sewerage_status ?? '') == 'Completed' ? 'selected' : ''); ?>>Completed</option>
                                    </select>
                                ...
                                <?php if(isset($siteDev->sewerage_photo)): ?>
                                    <?php $seweragePhotoUrl = str_starts_with($siteDev->sewerage_photo, 'uploads/') ? asset($siteDev->sewerage_photo) : asset('storage/' . $siteDev->sewerage_photo); ?>
                                    <div class="mt-3 relative rounded-lg overflow-hidden border border-slate-200 aspect-[16/9] bg-black">
                                        <a href="<?php echo e($seweragePhotoUrl); ?>" data-lightbox="site-development" data-title="Sewerage Progress Photo">
                                            <img src="<?php echo e($seweragePhotoUrl); ?>" alt="Sewerage Progress" class="w-full h-full object-cover cursor-zoom-in">
                                        </a>
                        ...
                        <div class="pt-2">
                            ...
                            <textarea name="remarks" rows="2" placeholder="Describe the current site engineering status or developmental details..." class="w-full text-xs border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 text-slate-700 bg-slate-50"><?php echo e(old('remarks', $siteDev->remarks ?? '')); ?></textarea>
                        </div>
                    ...
                    <div class="mt-6 border-t border-slate-150 pt-5">
                        <h4 class="text-[10px] font-black uppercase text-slate-400 tracking-wider mb-3 flex items-center gap-1.5">
                            ...
                            History Trail & Audit Logs (<?php echo e($logs->count()); ?> Entries)
                        </h4>
                                    ...
                                    <div class="bg-slate-50/60 hover:bg-slate-50 border border-slate-150 rounded-xl p-3.5 transition-all text-xs">
                                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1 border-b border-slate-200/50 pb-2 mb-2">
                                            <div class="flex items-center gap-1.5">
                                                <span class="w-6 h-6 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-[10px]">
                                                    <?php echo e(substr($log->updated_by_name, 0, 2)); ?>

                                                </span>
                                                <span class="font-extrabold text-slate-700"><?php echo e($log->updated_by_name); ?></span>
                                        ...
                                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[10px]">
                                            <div class="bg-white border border-slate-200/60 rounded px-2 py-1 flex flex-col justify-between">
                                                ...
                                                <span class="font-extrabold text-slate-700"><?php echo e($log->road_status); ?></span>
                                            </div>
                                            <div class="bg-white border border-slate-200/60 rounded px-2 py-1 flex flex-col justify-between">
                                                <span class="text-slate-400 font-bold uppercase text-[7px]">Water</span>
                                                <span class="font-extrabold text-slate-700"><?php echo e($log->water_status); ?></span>
                                            </div>
                                            <div class="bg-white border border-slate-200/60 rounded px-2 py-1 flex flex-col justify-between">
                                                <span class="text-slate-400 font-bold uppercase text-[7px]">Electricity</span>
                                                <span class="font-extrabold text-slate-700"><?php echo e($log->electricity_status); ?></span>
                                            </div>
                                            <div class="bg-white border border-slate-200/60 rounded px-2 py-1 flex flex-col justify-between">
                                                <span class="text-slate-400 font-bold uppercase text-[7px]">Sewerage</span>
                                                <span class="font-extrabold text-slate-700"><?php echo e($log->sewerage_status); ?></span>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.mmgayBdoAuth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sports\housing_project\resources\views/mmgay/bdo/site_development.blade.php ENDPATH**/ ?>