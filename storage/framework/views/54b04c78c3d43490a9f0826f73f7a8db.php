...
<?php $__env->startSection('title', 'MMSAY Login'); ?>
    ...
    height: 50px;">
                    ...
                    <div class="col-lg-7">
                        <div class="right-panel h-100 d-flex flex-column justify-content-center">
                            ...
                            <!-- FORM -->
                            <form id="loginForm" action="<?php echo e(route('mmsay.login')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\housing-project\resources\views/mmsay/departmentLogin.blade.php ENDPATH**/ ?>