        ...
        <main class="p-4 flex-grow flex flex-col gap-4 overflow-y-auto">
            ...
            <div class="space-y-2 shrink-0">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[120px] shadow-sm">
                        <div>
                            <a href="<?php echo e(route('ews.department.list', ['type' => 'ppt_members', 'district_id' => $districtId])); ?>" class="flex justify-between items-start cursor-pointer group/header">
                                <div>
                                    ...
                                    <h2 class="text-2xl font-black text-blue-600 font-mono mt-1 group-hover/header:text-blue-700 transition"><?php echo e(number_format($totalRegistrationCount)); ?></h2>
                                </div>
                            ...
                            <div class="space-y-1 text-xs font-bold text-slate-700 mt-2 pt-2 border-t border-slate-100">
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'registered', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-0.5 rounded hover:bg-blue-50/80 transition cursor-pointer group">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-1.5 h-1.5 rounded-full bg-blue-500 shrink-0"></span>
                                        <span class="text-slate-655 group-hover:text-blue-800">Verify in survey app:</span>
                                    </div>
                                    <div class="flex items-center gap-1">
                                        <span class="text-blue-700 font-extrabold font-mono"><?php echo e(number_format($registeredCount)); ?></span>
                                ...
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'not_in_survey', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-0.5 rounded hover:bg-rose-50/80 transition cursor-pointer group">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-1.5 h-1.5 rounded-full bg-rose-500 shrink-0"></span>
                                        <span class="text-slate-655 group-hover:text-rose-800">Rejected in survey app:</span>
                                    </div>
                                    <div class="flex items-center gap-1">
                                        <span class="text-rose-700 font-extrabold font-mono"><?php echo e(number_format($notInSurveyCount)); ?></span>
                    ...
                    <!-- PPP Exclusion -->
                    <a href="<?php echo e(route('ews.department.list', ['type' => 'rejected_ppp', 'district_id' => $districtId])); ?>" class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[98px] shadow-sm hover:shadow-md hover:border-rose-300 transition cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h2 class="text-2xl font-black text-rose-600 font-mono mt-1"><?php echo e(number_format($rejectedPppCount)); ?></h2>
                            </div>
                    ...
                    <!-- Property in India -->
                    <a href="<?php echo e(route('ews.department.list', ['type' => 'rejected_property', 'district_id' => $districtId])); ?>" class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[98px] shadow-sm hover:shadow-md hover:border-rose-300 transition cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h2 class="text-2xl font-black text-rose-700 font-mono mt-1"><?php echo e(number_format($rejectedPropertyCount)); ?></h2>
                            </div>
                    ...
                    <!-- House Ownership -->
                    <a href="<?php echo e(route('ews.department.list', ['type' => 'rejected_ownership', 'district_id' => $districtId])); ?>" class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[98px] shadow-sm hover:shadow-md hover:border-rose-300 transition cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h2 class="text-2xl font-black text-rose-700 font-mono mt-1"><?php echo e(number_format($rejectedOwnershipCount)); ?></h2>
                            </div>
                ...
                <div class="bg-slate-100 border border-slate-200 rounded-lg p-2 text-xs font-bold text-slate-650 flex items-center gap-2 shrink-0">
                    ...
                    <span>
                        Filtration: Verify in survey app (<?php echo e(number_format($registeredCount)); ?>) - Rejections (<?php echo e(number_format($rejectedPppCount)); ?> PPP + <?php echo e(number_format($rejectedPropertyCount)); ?> Prop + <?php echo e(number_format($rejectedOwnershipCount)); ?> House) = Eligible for booking (<?php echo e(number_format($eligibleDrawCount)); ?>)
                    </span>
                </div>
            </div>
            ...
            <div class="space-y-2 shrink-0">
                ...
                <div class="grid grid-cols-4 gap-3">
                    ...
                    <a href="<?php echo e(route('ews.department.list', ['type' => 'eligible_draw', 'district_id' => $districtId])); ?>" class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[120px] shadow-sm hover:shadow-md hover:border-indigo-300 transition cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h2 class="text-2xl font-black text-indigo-700 font-mono mt-1.5"><?php echo e(number_format($eligibleDrawCount)); ?></h2>
                            </div>
                    ...
                    <div class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[120px] shadow-sm">
                        <div>
                            ...
                            <div class="space-y-1 text-xs font-bold text-slate-700 mt-1.5">
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'booking', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-1 rounded-lg hover:bg-emerald-50/80 transition cursor-pointer group">
                                    <div class="flex items-center gap-2">
                                        <span class="w-2.5 h-2.5 rounded-full bg-emerald-500 shrink-0"></span>
                                        <span class="text-xs font-bold text-slate-700 group-hover:text-emerald-800">Received:</span>
                                        <span class="text-emerald-700 font-extrabold font-mono text-sm"><?php echo e(number_format($bookingCount)); ?></span>
                                    </div>
                                ...
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'not_visited', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-1 rounded-lg hover:bg-rose-50/80 transition cursor-pointer group border-t border-slate-100">
                                    <div class="flex items-center gap-2">
                                        <span class="w-2.5 h-2.5 rounded-full bg-rose-500 shrink-0"></span>
                                        <span class="text-xs font-bold text-slate-700 group-hover:text-rose-800">Not received:</span>
                                        <span class="text-rose-700 font-extrabold font-mono text-sm"><?php echo e(number_format($notVisitedCount)); ?></span>
                                    </div>
                        ...
                        <div class="text-[9px] text-slate-400 font-extrabold uppercase text-right leading-none border-t border-slate-100 pt-1 mt-1 font-mono">
                            Sum: <?php echo e(number_format($bookingCount + $notVisitedCount)); ?>
                    ...
                    <div class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[120px] shadow-sm">
                        <div>
                            ...
                            <div class="space-y-1 text-xs font-bold text-slate-700 mt-1.5">
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'adc_passed', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-1 rounded-lg hover:bg-emerald-50/80 transition cursor-pointer group">
                                    <div class="flex items-center gap-2">
                                        <span class="w-2 h-2 rounded-full bg-emerald-500 shrink-0"></span>
                                        <span class="text-xs font-bold text-slate-700 group-hover:text-emerald-800">Eligible:</span>
                                        <span class="text-emerald-700 font-extrabold font-mono text-sm"><?php echo e(number_format($adcPassedCount)); ?></span>
                                    </div>
                                ...
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'adc_failed', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-1 rounded-lg hover:bg-rose-50/80 transition cursor-pointer group border-t border-slate-100">
                                    <div class="flex items-center gap-2">
                                        <span class="w-2 h-2 rounded-full bg-rose-500 shrink-0"></span>
                                        <span class="text-xs font-bold text-slate-700 group-hover:text-rose-800">Not Eligible:</span>
                                        <span class="text-rose-700 font-extrabold font-mono text-sm"><?php echo e(number_format($adcFailedCount)); ?></span>
                                    </div>
                        ...
                        <div class="text-[9px] text-slate-400 font-extrabold uppercase text-right leading-none border-t border-slate-100 pt-1 mt-1 font-mono">
                            Sum: <?php echo e(number_format($adcPassedCount + $adcFailedCount)); ?>
                    ...
                    <div class="bg-white rounded-xl p-3 border border-slate-150 flex flex-col justify-between min-h-[120px] shadow-sm">
                        <div>
                            ...
                            <div class="space-y-1 text-xs font-bold text-slate-700 mt-1">
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'allotted', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-1 rounded-lg hover:bg-emerald-50/80 transition cursor-pointer group">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-2.5 h-2.5 rounded-full bg-emerald-500 shrink-0"></span>
                                        <span class="text-[11.5px] font-bold text-slate-700 group-hover:text-emerald-800">Allotted:</span>
                                        <span class="text-emerald-700 font-extrabold font-mono text-xs"><?php echo e(number_format($allottedCount)); ?></span>
                                    </div>
                                ...
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'pending', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-1 rounded-lg hover:bg-amber-50/80 transition cursor-pointer group border-t border-slate-100">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-2.5 h-2.5 rounded-full bg-amber-500 shrink-0"></span>
                                        <span class="text-[11.5px] font-bold text-slate-700 group-hover:text-amber-800">Waiting:</span>
                                        <span class="text-amber-700 font-extrabold font-mono text-xs"><?php echo e(number_format($pendingCount)); ?></span>
                                    </div>
                                ...
                                <a href="<?php echo e(route('ews.department.list', ['type' => 'draw_remaining', 'district_id' => $districtId])); ?>" class="flex items-center justify-between p-1 rounded-lg hover:bg-slate-100 transition cursor-pointer group border-t border-slate-100">
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="text-slate-650 font-extrabold font-mono text-xs"><?php echo e(number_format($drawRemainingCount)); ?></span>
                                    </div>
                        ...
                        <div class="text-[9.5px] text-slate-400 font-extrabold uppercase text-right leading-none border-t border-slate-100 pt-1 mt-1">
                            Sum: <?php echo e(number_format($adcPassedCount)); ?>
                ...
                <div class="bg-slate-100 border border-slate-200 rounded-lg p-2 text-xs font-bold text-slate-650 flex items-center gap-2 shrink-0">
                    <span class="material-symbols-outlined text-slate-400 text-sm">info</span>
                    <span>
                        Outcomes: Booking Amount Received (<?php echo e(number_format($bookingCount)); ?>) -> Eligible (<?php echo e(number_format($adcPassedCount)); ?>) [Allotted: <?php echo e($allottedCount); ?> + Waiting: <?php echo e($pendingCount); ?> + Unallotted: <?php echo e($drawRemainingCount); ?>] & Not Eligible (<?php echo e(number_format($adcFailedCount)); ?>)
                    </span>
                </div>
            </div>
            ...
            <div class="space-y-2 shrink-0 pt-2 border-t border-slate-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('ews.department.developers.index')); ?>" class="text-xs font-black text-amber-700 hover:text-amber-800 uppercase flex items-center gap-1">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <a href="<?php echo e(route('ews.department.developers.index')); ?>" class="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-xl p-3.5 border border-slate-700 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-slate-600 transition cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h2 class="text-2xl font-black text-white font-mono mt-1"><?php echo e(number_format($developerCount)); ?></h2>
                    ...
                    <a href="<?php echo e(route('ews.department.developer-flats.index')); ?>" class="bg-white rounded-xl p-3.5 border border-slate-150 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-amber-300 transition cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h2 class="text-2xl font-black text-amber-700 font-mono mt-1"><?php echo e(number_format($developerFlatsCount)); ?></h2>
                    ...
                    <a href="<?php echo e(route('ews.department.developer-logs.index')); ?>" class="bg-white rounded-xl p-3.5 border border-slate-150 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-slate-300 transition cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h2 class="text-2xl font-black text-slate-800 font-mono mt-1"><?php echo e(number_format($developerLogsCount)); ?></h2>
...
<?php /**PATH E:\sports\housing_project\resources\views/ews/department/dashboard.blade.php ENDPATH**/ ?>