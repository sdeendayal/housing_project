<?php $__env->startSection('title', 'Schedule Physical Possession Visit'); ?>
<?php $__env->startSection('page-title', 'Schedule Meeting & Visit'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid py-4">
    <a href="<?php echo e(route('pp.officer.eligibility-list')); ?>" class="btn btn-link text-decoration-none text-muted mb-3 ps-0">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-2 text-slate-800" style="font-size: 0.8rem;">
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-bold text-slate-800"><?php echo e($application->application_number); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div>
                                    ...
                                    ?>
                                    <span class="badge <?php echo e($badgeClass); ?> px-2 py-1 rounded-2 text-wrap text-start d-inline-block" style="font-size: 0.65rem; white-space: normal; line-height: 1.25;">
                                        <?php echo e($application->physical_possession_status); ?>
                            ...
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800"><?php echo e($application->applicant_name); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-700"><?php echo e($application->father_name ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800"><?php echo e($application->mobile); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800"><?php echo e($property?->purchaser_category ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-700"><?php echo e($property?->purchaser_marital_status ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800 font-monospace"><?php echo e($property?->purchaser_ppp_id ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800 font-monospace"><?php echo e($property?->purchaser_member_id ?? '—'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-2 text-slate-800" style="font-size: 0.8rem;">
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-bold text-slate-800"><?php echo e($property?->AssetName ?? $application->asset_name ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800"><?php echo e($property?->AssetSize ?? $application->asset_size); ?> <?php echo e($property?->Unit ?? $application->asset_unit); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800"><?php echo e($property?->purchaser_app_no ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-800">
                                    <?php echo e($property?->purchaser_reg_date ? \Carbon\Carbon::parse($property->purchaser_reg_date)->format('d M Y') : '—'); ?>
                            ...
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-700"><?php echo e($property?->SectorName ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-700"><?php echo e($property?->CityName ?? '—'); ?></div>
                            </div>
                            <div class="col-6 col-sm-4">
                                ...
                                <div class="fw-semibold text-slate-700"><?php echo e($property?->DistrictName ?? $application->district_name ?? '—'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-2 text-slate-800" style="font-size: 0.8rem;">
                            <div class="col-4">
                                ...
                                <div class="fw-bold text-slate-800">₹<?php echo e(number_format($property?->FlatCost ?? $application->flat_cost ?? 0, 2)); ?></div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="fw-bold text-success" title="Initial Deposit: ₹<?php echo e(number_format($initialDeposit ?? 0, 2)); ?> + Installments: ₹<?php echo e(number_format($installmentPaid ?? 0, 2)); ?>">₹<?php echo e(number_format($totalReceived ?? 0, 2)); ?></div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="fw-bold text-danger">₹<?php echo e(number_format($balanceAmount ?? 0, 2)); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body p-3">
                    <form action="<?php echo e(route('pp.officer.schedule-save', $application->secure_id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <table class="table table-sm table-borderless align-middle mb-0" style="font-size: 0.85rem;">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-top">
                                        ...
                                        <td class="pt-2">
                                            <input type="date" name="slot_date_1" id="slot_date_1" class="form-control form-control-sm rounded-3 <?php $__errorArgs = ['slot_date_1'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slot_date_1', $application && $application->visit_slot_1 ? $application->visit_slot_1->format('Y-m-d') : '')); ?>" required min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
                                            <?php $__errorArgs = ['slot_date_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                <div class="invalid-feedback fs-9 mt-1"><?php echo e($message); ?></div>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <td class="pt-2">
                                            <select name="slot_time_1" id="slot_time_1" class="form-select form-select-sm rounded-3 <?php $__errorArgs = ['slot_time_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                                ...
                                                ?>
                                                <option value="09:00:00" <?php echo e($t1 === '09:00:00' ? 'selected' : ''); ?>>09:00 AM - 10:00 AM</option>
                                                <option value="10:00:00" <?php echo e($t1 === '10:00:00' ? 'selected' : ''); ?>>10:00 AM - 11:00 AM</option>
                                                <option value="11:00:00" <?php echo e($t1 === '11:00:00' ? 'selected' : ''); ?>>11:00 AM - 12:00 PM</option>
                                                <option value="12:00:00" <?php echo e($t1 === '12:00:00' ? 'selected' : ''); ?>>12:00 PM - 01:00 PM</option>
                                                <option value="13:00:00" <?php echo e($t1 === '13:00:00' ? 'selected' : ''); ?>>01:00 PM - 02:00 PM</option>
                                                <option value="14:00:00" <?php echo e($t1 === '14:00:00' ? 'selected' : ''); ?>>02:00 PM - 03:00 PM</option>
                                                <option value="15:00:00" <?php echo e($t1 === '15:00:00' ? 'selected' : ''); ?>>03:00 PM - 04:00 PM</option>
                                                <option value="16:00:00" <?php echo e($t1 === '16:00:00' ? 'selected' : ''); ?>>04:00 PM - 05:00 PM</option>
                                            </select>
                                            <?php $__errorArgs = ['slot_time_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr class="align-top">
                                        ...
                                        <td class="pt-2">
                                            <input type="date" name="slot_date_2" id="slot_date_2" class="form-control form-control-sm rounded-3 <?php $__errorArgs = ['slot_date_2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slot_date_2', $application && $application->visit_slot_2 ? $application->visit_slot_2->format('Y-m-d') : '')); ?>" required min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
                                            <?php $__errorArgs = ['slot_date_2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <td class="pt-2">
                                            <select name="slot_time_2" id="slot_time_2" class="form-select form-select-sm rounded-3 <?php $__errorArgs = ['slot_time_2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                                ...
                                                ?>
                                                <option value="09:00:00" <?php echo e($t2 === '09:00:00' ? 'selected' : ''); ?>>09:00 AM - 10:00 AM</option>
                                                <option value="10:00:00" <?php echo e($t2 === '10:00:00' ? 'selected' : ''); ?>>10:00 AM - 11:00 AM</option>
                                                <option value="11:00:00" <?php echo e($t2 === '11:00:00' ? 'selected' : ''); ?>>11:00 AM - 12:00 PM</option>
                                                <option value="12:00:00" <?php echo e($t2 === '12:00:00' ? 'selected' : ''); ?>>12:00 PM - 01:00 PM</option>
                                                <option value="13:00:00" <?php echo e($t2 === '13:00:00' ? 'selected' : ''); ?>>01:00 PM - 02:00 PM</option>
                                                <option value="14:00:00" <?php echo e($t2 === '14:00:00' ? 'selected' : ''); ?>>02:00 PM - 03:00 PM</option>
                                                <option value="15:00:00" <?php echo e($t2 === '15:00:00' ? 'selected' : ''); ?>>03:00 PM - 04:00 PM</option>
                                                <option value="16:00:00" <?php echo e($t2 === '16:00:00' ? 'selected' : ''); ?>>04:00 PM - 05:00 PM</option>
                                            </select>
                                            <?php $__errorArgs = ['slot_time_2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr class="align-top">
                                        ...
                                        <td class="pt-2">
                                            <input type="date" name="slot_date_3" id="slot_date_3" class="form-control form-control-sm rounded-3 <?php $__errorArgs = ['slot_date_3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slot_date_3', $application && $application->visit_slot_3 ? $application->visit_slot_3->format('Y-m-d') : '')); ?>" required min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
                                            <?php $__errorArgs = ['slot_date_3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <td class="pt-2">
                                            <select name="slot_time_3" id="slot_time_3" class="form-select form-select-sm rounded-3 <?php $__errorArgs = ['slot_time_3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                                ...
                                                ?>
                                                <option value="09:00:00" <?php echo e($t3 === '09:00:00' ? 'selected' : ''); ?>>09:00 AM - 10:00 AM</option>
                                                <option value="10:00:00" <?php echo e($t3 === '10:00:00' ? 'selected' : ''); ?>>10:00 AM - 11:00 AM</option>
                                                <option value="11:00:00" <?php echo e($t3 === '11:00:00' ? 'selected' : ''); ?>>11:00 AM - 12:00 PM</option>
                                                <option value="12:00:00" <?php echo e($t3 === '12:00:00' ? 'selected' : ''); ?>>12:00 PM - 01:00 PM</option>
                                                <option value="13:00:00" <?php echo e($t3 === '13:00:00' ? 'selected' : ''); ?>>01:00 PM - 02:00 PM</option>
                                                <option value="14:00:00" <?php echo e($t3 === '14:00:00' ? 'selected' : ''); ?>>02:00 PM - 03:00 PM</option>
                                                <option value="15:00:00" <?php echo e($t3 === '15:00:00' ? 'selected' : ''); ?>>03:00 PM - 04:00 PM</option>
                                                <option value="16:00:00" <?php echo e($t3 === '16:00:00' ? 'selected' : ''); ?>>04:00 PM - 05:00 PM</option>
                                            </select>
                                            <?php $__errorArgs = ['slot_time_3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="visit_instructions" id="visit_instructions" class="form-control form-control-sm rounded-3 <?php $__errorArgs = ['visit_instructions'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="2" placeholder="Enter instructions for the citizen (e.g. documents to bring, precautions)..."><?php echo e(old('visit_instructions', $application ? $application->visit_instructions : '')); ?></textarea>
                            <?php $__errorArgs = ['visit_instructions'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            <a href="<?php echo e(route('pp.officer.eligibility-list')); ?>" class="btn btn-sm btn-outline-secondary px-3 rounded-pill">Cancel</a>
...
document.addEventListener('DOMContentLoaded', function() {
    const excludeId = <?php echo e($application->id); ?>;
    ...
    function updateTimeSlots(slotIndex) {
        ...
        fetch(`<?php echo e(route('pp.officer.schedule.capacity-check')); ?>?date=${selectedDate}&exclude_id=${excludeId}`)
...
<?php echo $__env->make('physical-possession.layouts.officer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\housing-project\resources\views/physical-possession/workflow/officer-schedule.blade.php ENDPATH**/ ?>