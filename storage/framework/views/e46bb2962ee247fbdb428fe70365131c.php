    ...
    <aside class="hidden md:flex flex-col w-64 bg-slate-900 text-slate-350 shrink-0 h-full shadow-xl z-20">
        ...
        <div class="flex-1 px-4 py-6 space-y-6 overflow-y-auto">
            <div>
                ...
                <div class="space-y-1">
                    <a href="<?php echo e(route('ews.developer.dashboard')); ?>" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white text-xs font-medium transition-all">
                    ...
                    <a href="<?php echo e(route('ews.developer.dashboard', ['ownership_scope' => 'my_flats'])); ?>" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white text-xs font-medium transition-all">
    ...
    <div class="flex-1 flex flex-col overflow-hidden h-full">
        ...
        <header class="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 shadow-sm z-10">
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('ews.developer.dashboard')); ?>" class="w-8 h-8 rounded-lg bg-sky-50 border border-sky-100 flex items-center justify-center text-sky-600 hover:bg-sky-600 hover:text-white transition-all shadow-sm">
            ...
            <div class="text-right">
                ...
                <div class="text-[8.5px] text-slate-500 font-mono">District: <span class="font-bold text-slate-700 uppercase"><?php echo e($user->district_name ?? 'N/A'); ?></span> | Mobile: <?php echo e($user->mobile); ?></div>
            </div>
        </header>
        ...
        <div class="flex-1 overflow-y-auto p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full max-w-5xl mx-auto">
                ...
                <div class="lg:col-span-7 bg-white border border-slate-200 rounded-xl shadow-sm dev-shadow overflow-hidden">
                    ...
                    <!-- Form Content -->
                    <form method="POST" action="<?php echo e(route('ews.developer.flats.store')); ?>" class="p-6 space-y-4" id="devCreateForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-1">
                                ...
                                <select id="district_id" name="district_id" required
                                    ...
                                    <?php if(count($districts) > 1): ?>
                                        <option value="" disabled <?php echo e(old('district_id') ? '' : 'selected'); ?>>Choose a district...</option>
                                    <?php endif; ?>
                                    <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($district->id); ?>" <?php echo e((count($districts) === 1 || old('district_id') == $district->id) ? 'selected' : ''); ?>>
                            ...
                            <div class="space-y-1">
                                ...
                                <select id="town_id" name="town_id" required
                                    ...
                                    <?php $__currentLoopData = $towns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $town): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($town->id); ?>" <?php echo e(old('town_id') == $town->id ? 'selected' : ''); ?>>
                                            <?php echo e(strtoupper($town->name)); ?>
                        ...
                        <div id="single-fields-container" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <select id="floor_number_single" name="floor_number" required
                                    ...
                                    <?php for($f = 1; $f <= 100; $f++): ?>
                                        <option value="<?php echo e($f); ?>">Floor <?php echo e($f); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                        ...
                        <div class="pt-2 flex gap-3">
                            <a href="<?php echo e(route('ews.developer.dashboard')); ?>"
...
<?php /**PATH E:\sports\housing_project\resources\views/ews/developer/create.blade.php ENDPATH**/ ?>