...
class RewariPropertyRejectSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info("Clearing existing Rewari records (dist_id = 19) from ews_reject_property_in_india_3 table...");
        DB::table('ews_reject_property_in_india_3')->where('dist_id', 19)->delete();

        $this->command->info("Seeding Rewari data into ews_reject_property_in_india_3 table (starting from row 2)...");
