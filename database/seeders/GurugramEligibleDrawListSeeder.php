...
class GurugramEligibleDrawListSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info("Clearing existing Gurugram records (dist_id = 6) from ews_eligible_draw_list_5 table...");
        DB::table('ews_eligible_draw_list_5')->where('dist_id', 6)->delete();

        $this->command->info("Seeding Gurugram data into ews_eligible_draw_list_5 table (starting from row 2)...");
