...
class EwsHouseOwnershipRejectSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info("Excel sheet 'house_ownership' loaded. Total rows: {$highestRow}, Total columns: {$highestColumnIndex}.");
        ...
        // Ensure ews_house_ownership_reject_4 has the columns
