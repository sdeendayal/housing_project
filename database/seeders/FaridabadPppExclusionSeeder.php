...
class FaridabadPppExclusionSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info("Clearing existing Faridabad PPP Exclusion records (dist_id = 4) from ews_reject_ppp_exclusion_2 table...");
        DB::table('ews_reject_ppp_exclusion_2')->where('dist_id', 4)->delete();

        $this->command->info("Seeding Faridabad data into ews_reject_ppp_exclusion_2 table (starting from row 2)...");
