...
class RewariHouseOwnershipRejectSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info("Clearing existing Rewari house ownership records (dist_id = 19) from ews_house_ownership_reject_4 table...");
        DB::table('ews_house_ownership_reject_4')->where('dist_id', 19)->delete();

        $this->command->info("Seeding Rewari data into ews_house_ownership_reject_4 table (starting from row 2)...");
