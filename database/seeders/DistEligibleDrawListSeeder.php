...
class DistEligibleDrawListSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $targetTable = 'ews_eligible_draw_list_5';
        ...
        foreach ($districts as $dist) {
            ...
            $sheet = $spreadsheet->getSheetByName('Eligible') ?: $spreadsheet->getSheetByName('eligible');
            if (!$sheet) {
                $this->command->error("Sheet 'Eligible' or 'eligible' not found in file {$dist['file']}.");
                continue;
            }
